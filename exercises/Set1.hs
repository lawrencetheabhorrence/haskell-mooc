...
checkPassword pass1 = if(pass1 == "swordfish" || pass1 == "mellon") then "You're in." else "ACCESS DENIED!"
...
postagePrice weight = if (weight <= 500) then 250 else if (weight > 5000) then (6000) else (300 + weight)
------------------------------------------------------------------------------
