...
data Person = PersonUndefined | MkPerson Int String
  deriving Show
...
data Position = PositionUndefined | MkPosition Int Int
...
rgb (Mix color1 color2) = [(((rgb color1) !! 0) + ((rgb color2) !! 0))/2,  (((rgb color1) !! 1) + ((rgb color2) !! 1))/2, (((rgb color1) !! 2) + ((rgb color2) !! 2))/2]
rgb (Invert color) = [1 - ((rgb color) !! 0), 1 - ((rgb color) !! 1), 1 - ((rgb color) !! 2)]
...
toNat :: Int -> Maybe Nat
toNat 0 = Just Zero
toNat n = if(n > -1) then Just (PlusOne (Data.Maybe.fromJust (toNat (n - 1)))) else Nothing
